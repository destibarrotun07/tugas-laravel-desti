...
<body>
    <form action="{{url ('welcome')}}" method="get">
        ...
        <input type="text" id="first-name" name="first-name" required value="first-name"><br><br>

        <label for="last-name">Last Name:</label>
        <input type="text" id="last-name" name="last-name" required value="first-name"><br><br>
